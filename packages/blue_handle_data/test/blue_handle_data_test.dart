...
void main() {
  final BlueHandleDataPlatform initialPlatform = BlueHandleDataPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    BlueHandleData blueHandleDataPlugin = BlueHandleData();
    MockBlueHandleDataPlatform fakePlatform = MockBlueHandleDataPlatform();
